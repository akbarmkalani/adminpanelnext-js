...
const LogHeader = ({ darkmode, setDarkmode, isLoggedIn, handleToggle, submitDark }) => {

    const renderSignUpLink = () => (
        <Link href='/signup'>
            <p>Don't have an account? <span className='text-green-600'>Sign Up for Free</span></p>
        </Link>
    );
    ...
    const renderLoginLink = () => (
        <Link href='/login'>
            <p>Already have an account?<span className='text-green-600'> Login</span></p>
        </Link>
    );
            ...
            <header className='flex p-5'>
                ...
                <div className='w-[50%]  flex justify-end items-center'>
                    <ul className='flex'>
                        ...
                        <li onClick={handleToggle} className='font-semibold text-[16px]'>
                            {isLoggedIn ? renderSignUpLink() : renderLoginLink()}
                        </li>
                    </ul>
