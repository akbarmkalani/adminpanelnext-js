...
import { Valadition } from '../login/valdition';
const SignUp = () => {
  ...
  return (
    <div className=' w-[100%]'>
      <LogHeader />
      <div className='w-[500px] h-[750px] flex justify-center items-center mt-6 border p-3 mx-auto'>
        <form action=""  onSubmit={submitHandaler}>
          <h1 className='text-center py-4 font-bold'>Create Account!</h1>
          <p>Register to your account and join u</p>
            ...
            <span className='w-full p-4 rounded-md flex border items-center '>
              ...
              /> <span>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="6" r="4" fill="#267DFF"></circle>
                  <ellipse opacity="0.3" cx="12" cy="17" rx="7" ry="4" fill="#267DFF"></ellipse>
                </svg>
              </span>
            </span>
