  ...
  return (
    <section className='flex w-full mt-[70px] justify-center'>
      <div className="w-[90%] flex my-14 h-[100vh]  bg-[#050C17] shadow-inset ring ring-offset-0 ring-indigo-300 ring-opacity-25 ring-offset-transparent ring-offset-inset sm:ring-offset-transparent sm:ring-offset-inset sm:ring-indigo-300 sm:ring-opacity-25 rounded-[10px]">
        <div className="w-[30%]  bgsituation "></div>
        ...
        <div className="w-[87%] bg-[#162131] text-[#7187aa]">
          ...
          <div className="flex flex-wrap justify-around mt-6">
            <section className="relative rounded-xl flex items-center h-[90px] w-[330px] ">
              ...
              >
                <span className="text-[23px] bg-[#40679e4d] rounded-[50%] flex items-center justify-center w-[60px] h-[60px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#267DFF" className="bi bi-share-fill" viewBox="0 0 16 16">
            ...
            <section className="relative rounded-xl  flex items-center h-[90px] w-[330px]">
              ...
              >
                <span className="text-[23px] bg-[#40679e4d] rounded-[50%] flex items-center justify-center w-[60px] h-[60px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#267DFF" class="bi bi-boxes" viewBox="0 0 16 16">
            ...
            <section className="relative rounded-xl mt-6 flex items-center h-[90px] w-[330px]">
              ...
              >
                <span className="text-[23px] bg-[#40679e4d] rounded-[50%] flex items-center justify-center w-[60px] h-[60px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#267DFF" class="bi bi-camera-video-fill" viewBox="0 0 16 16">
            ...
            <section className="relative rounded-xl mt-6 flex items-center h-[90px] w-[330px]">
              ...
              >
                <span className="text-[23px] bg-[#40679e4d] rounded-[50%] flex items-center justify-center w-[60px] h-[60px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#267DFF" class="bi bi-vector-pen" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M10.646.646a.5.5 0 0 1 .708 0l4 4a.5.5 0 0 1 0 .708l-1.902 1.902-.829 3.313a1.5 1.5 0 0 1-1.024 1.073L1.254 14.746 4.358 4.4A1.5 1.5 0 0 1 5.43 3.377l3.313-.828L10.646.646zm-1.8 2.908-3.173.793a.5.5 0 0 0-.358.342l-2.57 8.565 8.567-2.57a.5.5 0 0 0 .34-.357l.794-3.174-3.6-3.6z" />
                    <path fill-rule="evenodd" d="M2.832 13.228 8 9a1 1 0 1 0-1-1l-4.228 5.168-.026.086.086-.026z" />
                  </svg>
                </span>
                <span className="text-[23px]   font-bold ms-5">
                  I work at a mid company
                </span>
              </div>
            </section>
            ...
            <section className="relative rounded-xl mt-6 flex items-center h-[90px] w-[330px]">
              ...
              >
                <span className="text-[23px] bg-[#40679e4d] rounded-[50%] flex items-center justify-center w-[60px] h-[60px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#267DFF" class="bi bi-person-video3" viewBox="0 0 16 16">
...
l-29 21 -15 -36z"/>
            ...
            <section className="relative rounded-xl mt-6 flex items-center h-[90px] w-[330px]">
              ...
              >
                <span className="text-[23px] bg-[#40679e4d] rounded-[50%] flex items-center justify-center w-[60px] h-[60px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#267DFF" class="bi bi-cup-hot-fill" viewBox="0 0 16 16">
          ...
          <section className=" flex justify-around">
            <Link
              className={`text-white overflow-hidden flex justify-center items-center w-[200px] h-[60px] rounded-xl bg-[#267DFF] mt-8 `}
              href='/contacts'
              onMouseOver={handleMovesEvent}
              onMouseOut={handleMovesEvent}
            >
              <span className={` ms-6 ${isMoved ? 'translate-x-[-32px]' : 'translate-x-[-200px]'}`}>
